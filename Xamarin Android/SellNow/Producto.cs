...
namespace SellNowMenu
{
	public class SellNowContainer : FrameLayout
	{
		bool opened;
		int contentOffsetX;
		...
		public SellNowContainer (Context context) :
			base (context)
		{
			Initialize ();
		}

		public SellNowContainer (Context context, IAttributeSet attrs) :
			base (context, attrs)
		{
			Initialize ();
		}

		public SellNowContainer (Context context, IAttributeSet attrs, int defStyle) :
		...
		View ContentView {
			get {
				return FindViewById (Resource.Id.SellNowContent);
			}
		}

		View MenuView {
			get {
				return FindViewById (Resource.Id.SellNowMenu);
			}
		}
